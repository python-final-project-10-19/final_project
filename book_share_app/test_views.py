...
#         self.book_one = Book.objects.create(title='War and Peace', author='Tolstoy', status='complete', user=self.user)
#         self.book_two = Book.objects.create(title='Walden', author='Thoreau', status='complete', user=self.user)
